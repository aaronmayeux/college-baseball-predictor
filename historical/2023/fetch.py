...
if __name__=='__main__':
 b,m=fetch('rpi.html','https://www.warrennolan.com/baseball/2023/rpi-live');print(m)
 b,m=fetch('LSU.html','https://www.warrennolan.com/baseball/2023/schedule/LSU');print(m)
