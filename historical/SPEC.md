...
Further experiments should integrate these bounded checks; earlier-window feasibility planning and broad archive/school audits are not prerequisites. The [completed OBP/ERA experiment](../docs/Team_Component_Experiment.md) applies this contract: its raw-rate candidate failed 2024 game and advancement checks and is closed without promotion. Any schedule-adjusted successor needs a separate locked plan; do not retune this candidate on 2024.
