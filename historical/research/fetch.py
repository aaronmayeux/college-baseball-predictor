...
if __name__=='__main__':
 b,m=fetch('rpi.html','https://www.warrennolan.com/baseball/2021/rpi-live');print(m)
 b,m=fetch('LSU.html','https://www.warrennolan.com/baseball/2021/schedule/LSU');print(m)
