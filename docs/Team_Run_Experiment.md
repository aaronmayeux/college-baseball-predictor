...
**Close the net-run candidate without promotion. Keep the existing Elo app.** Do not collect more individual pitcher data or tune this candidate to rescue its 2024 performance. The separate [component-source decision](Team_Component_Source_Decision.md) now retains Elo and selects College Splits as the sole prospective licensed-sample route, pending authorization and qualification. Component acquisition is paused; no further school probes or candidate rescue work is queued.
