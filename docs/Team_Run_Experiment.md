...
**Close the net-run candidate without promotion. Keep the existing Elo app.** Do not collect more individual pitcher data or tune this candidate to rescue its 2024 performance. The separate [component-source decision](Team_Component_Source_Decision.md) now retains Elo under Aaron’s zero-budget rule. The free archive checked lacks team-stat rows for 2021–2023; component acquisition stays blocked. No paid inquiry, further school probes or candidate rescue work is queued.
