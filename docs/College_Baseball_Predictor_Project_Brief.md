...
The [focused input qualification](Model_Input_Qualification.md) now includes a verified offline hitting extractor: LSU contact/power/OBP and Missouri State power/OBP, with both cutoff modes and explicit missing denominators. These descriptive inputs do not establish predictive gains.

The separate pitching extractor now verifies BF and explicit starts across 180 LSU/Davidson/Missouri State boxes and produces complete cutoff-specific workload/role summaries. Missing pitch counts and actual work dates prevent rest claims. The [staged expansion plan](Model_Input_Qualification.md#multi-season-expansion-plan) now starts with the four-team 2022 Stillwater regional (three new team-seasons), then targets the 2021–2024 NCAA fields for full-field testing. Separate 2021 evidence qualifies 64 seeds retrospectively. Retained logs qualify all four hitting measures for Oklahoma State and Grand Canyon in both modes after season-count and PA/BF reconciliation. Arkansas’s retained first box now passes hitting/BF/starting-role checks; its linked season count reports are absent. Next: review access for those two exact reports, then finish season qualification. Bulk scope remains unverified. Depth/ace thresholds and scaling remain open.
