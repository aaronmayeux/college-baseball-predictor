...
The separate pitching extractor now verifies BF and explicit starts across 180 LSU/Davidson/Missouri State boxes and produces complete cutoff-specific workload/role summaries. Missing pitch counts and actual work dates prevent rest claims. The [staged expansion plan](Model_Input_Qualification.md#multi-season-expansion-plan) now starts with the four-team 2022 Stillwater regional (three new team-seasons), then targets the 2021–2024 NCAA fields for full-field testing. The three new schools now have reconciled result inventories and checked sample boxes; separate 2021 selection evidence qualifies 64 seeds retrospectively. Next: clear source-specific season scope and finish preflight feature qualification. No new bulk collection is cleared. Depth/ace thresholds and scaling remain open.
